...
resource "oci_identity_policy" "ods_policy" {
  ...
  statements = ["Allow group ${var.ods_group_name} to manage api-gateway-family in ${var.compartment_policy_statement_substring}",
  ...
  "Allow dynamic-group ${var.ods_dynamic_group_name} to manage data-science-family in ${var.compartment_policy_statement_substring}",
  ...
  "Allow service datascience to use virtual-network-family in ${var.compartment_policy_statement_substring}",

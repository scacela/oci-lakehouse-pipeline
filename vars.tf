...
variable "current_user_ocid" { default = "" } # for Terraform deployment, current_user_ocid can be left unused. It is only used during Resource Manager deployment.
...
variable "compartment_dynamic_group_is_deployed" { default = true }
variable "compartment_dynamic_group_name" { default = "CompartmentDynamicGroup" }
variable "compartment_dynamic_group_description" { default = "Group defined by a rule that matches particular resource-types within a given compartment." }
...
variable "vcn_dynamic_group_is_deployed" { default = true }
variable "vcn_dynamic_group_name" { default = "VirtualCloudNetworkDynamicGroup" }
variable "vcn_dynamic_group_description" { default = "Group defined by a rule that matches particular resource-types within a given compartment." }
...
variable "adw_dynamic_group_is_deployed" { default = true }
variable "adw_dynamic_group_name" { default = "AutonomousDataWarehouseDynamicGroup" }
variable "adw_dynamic_group_description" { default = "Group defined by a rule that matches particular resource-types within a given compartment." }
...
variable "oac_dynamic_group_is_deployed" { default = true }
variable "oac_dynamic_group_name" { default = "AnalyticsCloudDynamicGroup" }
variable "oac_dynamic_group_description" { default = "Group defined by a rule that matches particular resource-types within a given compartment." }
...
variable "bucket_dynamic_group_is_deployed" { default = true }
variable "bucket_dynamic_group_name" { default = "BucketDynamicGroup" }
variable "bucket_dynamic_group_description" { default = "Group defined by a rule that matches particular resource-types within a given compartment." }
...
variable "streaming_dynamic_group_is_deployed" { default = true }
variable "streaming_dynamic_group_name" { default = "StreamingDynamicGroup" }
variable "streaming_dynamic_group_description" { default = "Group defined by a rule that matches particular resource-types within a given compartment." }
